<html>
<head>
<title>DoutorAuto :: Home ::</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<link href="web/css/style.css" rel="stylesheet" type="text/css" media="all"/>
<link rel="stylesheet" href="web/css/slider.css" type="text/css" media="screen" />
		 ...
		 <div class="header_top">
		 	 <div class="wrap">
					...
					<div class="dail">
						...
						<p><img src="web/images/mobile.png">62 3922-0500</p>
					</div>
					<div class="clear"></div>
					</div>	
		     </div>
	    	  ...
	    	  <div class="section group">
	    	   ...
	    	   <div class="content-bottom">
		    	   	<div class="section group">
						...
						<img src="web/images/welcome.jpg" alt=""/>
						<p style="padding-top:5px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
					</div>
						<div class="col_1_of_3 span_1_of_3">
							<h3>O que fazemos</h3>
							   <ul>
						...
						<div class="col_1_of_3 span_1_of_3">
							<h3>Nossa Equipe</h3>
							<div class="post-grid">
								<img src="web/images/team-1.jpg" alt="" />
								<p><span>Amilson Monteiro</span></p>
									<p>Lorem ipsum dolor sit amet consectetur dolor more normal of letters,<a href="#">[...]</a></p>
								<div class="clear"> </div>
					 		 </div>
					 		 <div class="post-grid">
								<img src="web/images/team-2.jpg"  alt="" />
								<p><span>Douglas Freitas</span></p>
									<p>Lorem ipsum dolor sit amet consectetur dolor more normal of letters,<a href="#">[...]</a></p>
								<div class="clear"> </div>
					 		 </div>
					 		 <div class="post-grid">
								<img src="web/images/team-3.jpg" alt="" />
								<p><span>Evandro José</span></p>
									<p>Lorem ipsum dolor sit amet consectetur dolor more normal of letters,<a href="#">[...]</a></p>
								<div class="clear"> </div>
					 		 </div>
						</div>
   	 ...
   	 <div class="footer_grides">
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h3>Localização</h3>
					      <ul>
						  	  <li>Av. C-12 n°134 Qd. 66 Lt. 13</li>
						  	  <li>Setor Sudoeste</li>
						  	  <li>Goiânia - GO</li>
						  	 <li><span>e-mail:</span> contato@doutorauto.com.br</li>
						  	 <li><span>Telefone:</span> 62 3922 0500</li>
						  </ul>
				</div>
			</div>
	    </div>
		 ...
		 <div class="copy_right">
		 	 <div class="wrap">
				<p>DoutorAuto © Todos os Direitos Reservados | Design by  <a href="http://w3layouts.com">W3Layouts</a> | Desenvolvido por <a href="http://www.zenn.com.br">Zenn Consultoria</a></p>
			 </div>
		</div>	
		<!------------ scroll Top ------------>
	 <script type="text/javascript">
